 ...
 */
package com.boas.project.config;
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth)
        throws Exception{
            ...
            protected void configure(HttpSecurity http) throws Exception {
                http
                        .authorizeRequests()
                            .antMatchers(HttpMethod.GET,"/api/project/**").hasRole("PROJECT_VIEW")
                            .antMatchers(HttpMethod.POST,"/api/project/**").hasRole("PROJECT_CREATE")
                            .antMatchers(HttpMethod.DELETE,"/api/project/**").hasRole("PROJECT_DELETE")
                            .antMatchers(HttpMethod.PUT,"/api/project/**").hasRole("PROJECT_UPDATE")
